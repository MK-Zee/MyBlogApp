...
public class MyBlogAppDbContext :
    AbpDbContext<MyBlogAppDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public MyBlogAppDbContext(DbContextOptions<MyBlogAppDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            p.ToTable(MyBlogAppConsts.DbTablePrefix + "Posts",
        ...
        {
            c.ToTable(MyBlogAppConsts.DbTablePrefix + "Categories",
                MyBlogAppConsts.DbSchema);
        ...
        {
            c.ToTable(MyBlogAppConsts.DbTablePrefix + "Comments",
                MyBlogAppConsts.DbSchema);
            c.ConfigureByConvention(); //auto configure for the base class props
        ...
        //{
        //    b.ToTable(MyBlogAppConsts.DbTablePrefix + "YourEntities", MyBlogAppConsts.DbSchema);
